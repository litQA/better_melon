package net.qamelontweaks;

import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.LogManager;

import net.qamelontweaks.init.QaBetterMelonModTabs;
import net.qamelontweaks.init.QaBetterMelonModItems;
...
@Mod("qa_better_melon")
public class QaBetterMelonMod {
	public static final Logger LOGGER = LogManager.getLogger(QaBetterMelonMod.class);
	public static final String MODID = "qa_better_melon";

	public QaBetterMelonMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		QaBetterMelonModBlocks.REGISTRY.register(modEventBus);

		QaBetterMelonModItems.REGISTRY.register(modEventBus);

		QaBetterMelonModTabs.REGISTRY.register(modEventBus);
